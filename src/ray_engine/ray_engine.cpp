...
Vec3 ColorForRay(const Ray &r, const RenderContext &render_context,
    ...
    if (render_context.world_ptr->Hit(r, 0.001f, MAXFLOAT, hit_record)) {
...
//        ScatterRecord scatter_record;  // set in DoScatter, lifetime if world-hit
...
//                        = hit_record.material_ptr->ScatteringContribution(r, hit_record);
//                return emitted
//                    + scatter_record.attenuation
////                    * ColorForRay(scatter_record.specular_ray, render_context,
//                    * coefficient
//                    * ColorForRay(scatter_ray, render_context, depth + 1);
//            } else if (scatter_record.do_mixture_pdf){
//            if (scatter_record.do_mixture_pdf){
//                // So PBFs have a Value and Generate function.
//                // Materials have a ScatteringPdf
//                // and a DoScatter function that returns a scatter record
//                // that includes a pdf.
//
...
//                        * ColorForRay(scattered, render_context, depth + 1) / pdf_value;
//            } else {
